...
const GCS_KEY = getCredentials('new-zerolens-api.json', 'GOOGLE_APPLICATION_CREDENTIALS_JSON');
const storage = new Storage({ 
    ...(typeof GCS_KEY === 'string' ? { keyFilename: GCS_KEY } : { credentials: GCS_KEY })
});

const BUCKET_NAME = process.env.GCS_BUCKET_NAME || 'zerolensbucket-cdn';

const VERTEX_KEY = getCredentials('new-zerolens-api.json', 'GOOGLE_APPLICATION_CREDENTIALS_JSON');
