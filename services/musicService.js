...
// Ensure it doesn't crash on startup if the key is missing or not loaded yet.
// If the key is truly missing, it will throw when actually generating.
const apiKey = process.env.GOOGLE_API_KEY || process.env.VITE_GOOGLE_API_KEY || 'MISSING_KEY';
