import { Bot, Clapperboard, Settings, ChevronLeft, ChevronRight, Camera, FolderOpen, Users, Shield, Video, Sparkles } from 'lucide-react'
...
export function Sidebar({ activeTab, setActiveTab, isCollapsed, toggleCollapse }) {
    ...
    useEffect(() => {
        checkRuntimeMode();
        if ((activeTab === 'directors-cut' || activeTab === 'director-studio') && !isCollapsed) {
