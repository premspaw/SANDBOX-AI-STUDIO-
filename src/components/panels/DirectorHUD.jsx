...
export default function DirectorHUD() {
    const activeCharacter = useAppStore(state => state.activeCharacter);
    const camera = useAppStore(state => state.camera);
    const wardrobeImage = useAppStore(state => state.wardrobeImage);
    const poseImage = useAppStore(state => state.poseImage);
    const anchorImage = useAppStore(state => state.anchorImage);
    const detailMatrix = useAppStore(state => state.detailMatrix);
    const currentProduct = useAppStore(state => state.currentProduct);
    const actionScript = useAppStore(state => state.actionScript);
    const lastGeneratedPrompt = useAppStore(state => state.lastGeneratedPrompt);
    ...
    const setWardrobeImage = useAppStore(state => state.setWardrobeImage);
    const setPoseImage = useAppStore(state => state.setPoseImage);
    const generateStoryboard = useAppStore(state => state.generateStoryboard);
    const addNode = useAppStore(state => state.addNode);
    const updateNodeData = useAppStore(state => state.updateNodeData);
    const syncCurrentSession = useAppStore(state => state.syncCurrentSession);
    const deleteNode = useAppStore(state => state.deleteNode);
    const setMode = useAppStore(state => state.setMode);
    const purgeVault = useAppStore(state => state.purgeVault);
    const addUGCPipelineNode = useAppStore(state => state.addUGCPipelineNode);
    const addUGCEngineNode = useAppStore(state => state.addUGCEngineNode);
    const addCameraNode = useAppStore(state => state.addCameraNode);
    const addLightingNode = useAppStore(state => state.addLightingNode);
    const addMusicNode = useAppStore(state => state.addMusicNode);
    const addSFXNode = useAppStore(state => state.addSFXNode);
    const addDialogueNode = useAppStore(state => state.addDialogueNode);
    const setRepairSession = useAppStore(state => state.setRepairSession);
        ...
        try {
            ...
            const renderTasks = ghostNodeIds.map(async (id, i) => {
                ...
                if (result) {
                    ...
                    saveStoryboardItem(activeCharacter.id, result, nodes.length + i);
