...
export const SonicDock = () => {
    // ⚡ Bolt: Using granular selectors to prevent unnecessary re-renders when the store updates
    // (e.g. during node dragging which updates node positions at 60fps)
    ...
    // ⚡ Bolt: Memoizing tools array to prevent re-creation on every render
    const tools = useMemo(() => [
