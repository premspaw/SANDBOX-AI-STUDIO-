...
export const SonicDock = memo(() => {
    // ⚡ Bolt: Use granular selectors to prevent unnecessary re-renders when other store state changes
    const {
        addInfluencerNode,
        addSeedanceNode,
    ...
    const [narrative, setNarrative] = useState(''); // Added missing local state to fix crash
