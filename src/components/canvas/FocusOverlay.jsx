...
export const FocusOverlay = () => {
    ...
    const handleRemap = async () => {
        if (focusedNodeId && !isVideo) {
            ...
            try {
                const { generateCharacterImage, buildConsistencyRefs, expandPrompt } = await import('../../services/geminiService');
    ...
    const handleExecuteRepair = async (repairPrompt) => {
        ...
        try {
            const { generateSurgicalRepair } = await import('../../services/geminiService');
                    ...
                    >
                        ...
                        <button
                            ...
                            onClick={() => {
                                ...
                                if (!prompt) {
                                    window.toast("Please describe the repair needed.");
                                    return;
                                }
