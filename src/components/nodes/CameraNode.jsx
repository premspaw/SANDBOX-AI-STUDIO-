    ...
    return (
        <div className="relative group" style={{ zIndex: 1 }}>
            <motion.div
                ...
                className="px-5 py-4 bg-[#0a0a0a]/90 backdrop-blur-2xl border-2 border-blue-500/20 rounded-2xl min-w-[250px] shadow-[0_20px_40px_rgba(0,0,0,0.4)] hover:border-blue-500/50 transition-all overflow-hidden font-sans"
            >
            ...
            <MagneticHandle type="target" position={Position.Left} color="#3b82f6" className="handle-location" />
            <MagneticHandle type="source" position={Position.Right} color="#3b82f6" className="handle-location" />
        </div>
    );
});
