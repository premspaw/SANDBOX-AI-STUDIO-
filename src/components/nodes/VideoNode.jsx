...
const VideoNode = ({ id, data }) => {
    ...
    const handleCritique = async () => {
        ...
        try {
            const { analyzeSceneMultimodal } = await import('../../services/geminiService');
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            window.toast("Failed to save video to Cloud Assets.");
        } finally {
            setIsSaving(false);
        }
    };
    ...
    return (
        ...
        >
            ...
            <MagneticHandle type="target" position={Position.Left} color="#bef264" />
            <MagneticHandle type="source" position={Position.Right} color="#bef264" />
        </motion.div>
    );
};
