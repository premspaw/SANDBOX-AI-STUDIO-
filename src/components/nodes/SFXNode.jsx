...
export default memo(({ id, data }) => {
    ...
    return (
        <motion.div
            ...
            <MagneticHandle type="target" position={Position.Left} color="#eab308" className="handle-location" />
            ...
            <MagneticHandle type="source" position={Position.Right} color="#eab308" className="handle-location" />
        </motion.div>
    );
});
