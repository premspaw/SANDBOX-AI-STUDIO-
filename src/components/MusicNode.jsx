...
export default memo(({ id, data }) => {
    ...
    return (
        ...
        >
            <Handle type="target" position={Position.Left} className={`!w-4 !h-4 !bg-pink-500 !border-4 !border-[#050505] !shadow-lg hover:!scale-125 transition-all handle-story ${isTargetConnected ? 'neural-engaged' : ''}`} />
            ...
            <Handle type="source" position={Position.Right} className={`!w-4 !h-4 !bg-pink-500 !border-4 !border-[#050505] !shadow-lg hover:!scale-125 transition-all handle-story ${isSourceConnected ? 'neural-engaged' : ''}`} />
        </motion.div>
    );
});
