# ByteDance Seedance 2.0 API Documentation (KIE.AI)
...
| `input.resolution` | enum | No | `480p`, `720p`, `1080p`, or `4k` (default: `720p`) |
...
- 4K resolution available on Seedance 2.0 only (not on Fast or Mini)
