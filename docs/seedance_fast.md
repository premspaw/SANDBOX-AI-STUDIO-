# Seedance Fast API Documentation
...
- Security audit
- New
- Through API Key Authorization
- Compatible with OpenAI SDK. Authorized inference access point by creating API Key
- Easy-to-use

## Access Process

### 1. Select API Key
Please set the API Key as an environment variable as follows:
```bash
export ARK_API_KEY="YOUR_API_KEY"
```
It needs to be replaced with the API Key you generated on the platform.

### 2. Select Sample Code
REST API call example

#### Calling Guide
Please refer to the following example code to call:
